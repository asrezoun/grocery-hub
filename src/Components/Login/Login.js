    ...
    return (
        ...
        <div className="loginForm container py-5" >
            <form onSubmit={handleSubmit(onSubmit)} className="form form-login">
                {flag && <input className="form-control" name="name" placeholder="Enter Your Name" ref={register({ required: true, maxLength: 20 })} />}
                <input className="form-control" name="email" placeholder="Enter Your Email" ref={register({ required: true, pattern: /\S+@\S+\.\S+/ })} />
                {errors.email && <span className="error">Valid Email required</span>}
                <input className="form-control" name="password" type="password" placeholder="Enter Your Password" ref={register({ required: true, min: 6, max: 99 })} />
                ...
                <button className="btn btn-primary form-control" onClick={handleGoogleSignIn}> Sign in With Google</button>
                {
