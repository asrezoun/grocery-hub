...
const Header = () => {
  ...
  const handleLogOut = ()=>{
    ...
    return (
        ...
        <Navbar.Brand><Link style={{ textDecoration: 'none', fontSize:"35px" }} to="/home"><strong>GROCERY HUB</strong></Link></Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav" className="justify-content-end">
          <Nav className="me-auto">
            <Nav.Link className="nav"><Link style={{ textDecoration: 'none' }} to="/home">Home</Link></Nav.Link>
            <Nav.Link className="nav"><Link style={{ textDecoration: 'none' }} to="/admin">Admin</Link></Nav.Link>
            <Nav.Link className="nav"><Link style={{ textDecoration: 'none' }} to="/orders">Orders</Link></Nav.Link>
